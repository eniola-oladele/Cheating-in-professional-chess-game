...
d3.json(url, function (error, data) {
  ...
  text("Cheating in Professional Chess Game");
  ...
  text("35 Fastest times up Eniola");
  ...
  style("text-anchor", "end").
  text(function (d) {
    if (d) return "Players with cheating allegations";else
    {
      return "No cheating allegations";
    };
  });
